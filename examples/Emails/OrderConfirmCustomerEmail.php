...
class OrderConfirmCustomerEmail {
	...
	public static function get_content_html() {
		...
		$html .= $mailer->column_start( 'padding:15px;' );
		$html .= $mailer->add_paragraph(
			'Your order will be delivered to this address:<br/>' . static::customer_address(),
		...
		$data      = [
			[
				'sl'        => 1,
				'details'   => 'Fresho Amaranthus - Green 250 g',
				'qty'       => '2',
				'sub_total' => 'Rs. 36.00',
			],
			[
				'sl'        => 2,
				'details'   => 'Fresho Basale Leaf 250 g',
				'qty'       => '1',
				'sub_total' => 'Rs. 10.00',
			],
			[
		...
		$foot_data = [
			...
			[
				[
					'label'   => 'Credit availed from bigbasket Wallet:',
					'colspan' => 3,
					'numeric' => true,
				],
				[
